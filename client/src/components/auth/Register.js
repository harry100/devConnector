            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                <div className="form-group">
                  ...
                  {errors.name && (<div className="invlalid-feedback">{errors.name}</div>)}
                </div>
                <div className="form-group">
                  ...
                  {errors.email && (<div className="invlalid-feedback">{errors.email}</div>)}
                ...
                <div className="form-group">
                  ...
                  {errors.password && (<div className="invlalid-feedback">{errors.password}</div>)}
                </div>
                <div className="form-group">
                  <input type="password" className={classnames('form-control form-control-lg', {
                    'is-invalid': errors.name
                  ...
                  {errors.password2 && (<div className="invlalid-feedback">{errors.password2}</div>)}
